...
namespace Checkers
{
    ...
    public class Checker //checker class containing color, symbol and establishes position
    {
        ...
        private void SetTeam(Color checkerColor) //assigns team color to checkers
        {
